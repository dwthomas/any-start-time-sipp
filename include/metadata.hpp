...
inline po::variables_map parse_arguments(int argc, char *argv[]){
    ...
    try{
        ...
        desc.add_options()
            ...
            ("movement", po::value<std::string>()->default_value("eight"), "The type of movement eight, four")
            ...
            ("maxquery", po::value<double>()->default_value(8.0), "The latest start time to be queried")
...
class Metadata{
    ...
    public:
        ...
        long generated;
        long plan_attempts;
        Metadata(int argc, char *argv[]):expansions(0),generated(0),plan_attempts(0){
